main-exe:
	...
	flexlink -exe -chain mingw64 -o main.exe -LD:/opam/default/lib/ocaml/flexdll -LD:/opam/default/lib/ocaml main.o caml_external_interop.o caml_callback_interop.o caml_callback_with_runtime.o -lwinmm -lgdi32 -lpthread -lws2_32 -lole32 -luuid -lversion -lshlwapi -lsynchronization  -l:libpthread.a